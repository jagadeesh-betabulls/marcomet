...
// Modified 5/22/09 for auth_dont_redirect
if(!isset($auth_dont_redirect)) $auth_dont_redirect = false;

if (!$valid && !$auth_dont_redirect)
    {
	...
	?>
	<script>
	location.href="<?=$baseurl?>/login.php?url=<?=urlencode($path)?>";
	</script>
	<?
    exit();
    }
