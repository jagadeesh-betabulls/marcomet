...
for (i = 1; i <= pagecount; i++) {
	...
	f=0;
	x=0;
    for (int z=0; z<vBlocks.size(); z=z+7) {
				...
				if (pdipage2 == -1) {
		    	    ...
		    	    if(!fillText.equals("")){
			    		if(vBlocks.get(z+2).toString().equals("13")){
			    			...
			    			fillText="Toll-Free&nbsp;1."+fillText.replaceAll(" ","").replaceAll("-","\\.");
			    			...
			    			fillText="Fax: "+fillText.replaceAll(" ","").replaceAll("\\.","-");
			    		}else if(vBlocks.get(z+2).toString().equals("10")){
			    			fillText="Phone: "+fillText.replaceAll(" ","").replaceAll("\\.","-");
			    		...
			    		%><!--  <%="|vbp7="+vBlocks.get(z+6).toString()%> --><%
			    	if(lastBlockName.equals(vBlocks.get(z).toString())){
			    		%><!--  <%="|vbp7="+vBlocks.get(z+6).toString()+",F1|"+z+": "+fillText%> --><%
			    %><!--  <%="|LFT1|"+z+": "+lastFillText%> --><%
			    		fillText=lastFillText+"\r"+fillText;
			    		%><!--  <%="|F2|"+z+": "+fillText%> --><%
			    	}
