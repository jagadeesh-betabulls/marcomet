...
<p class="Title">Purchasing Invoice History Report</p>
...
if(rsARInvoices.next()){
  ...
  do{
   ...
   rTotalSalesTax += rsARInvoices.getDouble("ar_sales_tax");
    ...
    alt=((alt.equals(""))?"alt":"");
    %><tr>
    <td class="lineitemcenter<%=alt%>" ><%=rsARInvoices.getString("vendor_id")%></td>
