...
<script>
	...
	<div id='filters'>
	<form method="post" action="/reports/vendors/AgedARRptFilters.jsp">
  ...
  do{
    ...
    if(rsARInvoices.getDouble("ar_invoice_amount")-amountPaid != 0){
	 ...
	 ageOver120+=((rsARInvoices.getInt("aging")>121) ? (rsARInvoices.getDouble("ar_invoice_amount")-amountPaid) : 0);
      ...
      alt=((alt.equals(""))?"alt":"");
      %><tr><td class="lineitemcenter<%=alt%>" ><%=rsARInvoices.getString("contact_id")%></td>
      <td class="lineitemcenter<%=alt%>" ><%=rsARInvoices.getString("site_number")%></td>
...
<td class="minderheaderright" colspan=6><span class='subtitle'>Report Totals:</span></td>
