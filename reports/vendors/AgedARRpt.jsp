...
String siteNumberFilter=( (sitenumberEntry.equals("")) ? "":" AND (c.default_site_number = '"+sitenumberEntry+"' or c.default_pm_site_number = '"+sitenumberEntry+"' or c3.company_name like '%"+sitenumberEntry+"%')");
