...
String sqlContactDD = "SELECT id 'value', concat(brand_code,':',prod_line_name,'  [',id,'] ') 'text' FROM product_lines c WHERE company_id = " + request.getParameter("companyId") + "  and status_id=2  ORDER BY prod_line_name "; 
...
<input type="hidden" name="currentPl" value="<%=request.getParameter("valueFieldVal")%>">
<input type="hidden" name="brandCode" value="<%=request.getParameter("brandCode")%>">
