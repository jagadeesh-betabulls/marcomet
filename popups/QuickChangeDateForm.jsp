...
<input type="hidden" name="$$Return" value="<%=((request.getParameter("refreshOpener")!=null)?"<script>window.opener.document.forms[0].submit();":"</script>parent.window.opener.location.reload();")%>setTimeout('close()',500);</script>">
