...
%><%if (!surveyURL.equals("")){
	%><html><head><script>
	srvFrame1 = parent.document.getElementById("divPop");
	srvFrame1.style.width = '<%=sl.getValue("surveys","id",surveyId, "survey_width")%>';
	srvFrame1.style.height = '<%=sl.getValue("surveys","id",surveyId, "survey_height")%>';
	window.location.href="http://www.surveymonkey.com/s.aspx?sm=N4_2fod_2fYz0yQ8_2fGaW7oOl8w_3d_3d";</script></head></html><%
}else if (closeThis){
