...
<%
    ...
    if (request.getParameter("submitted") != null && request.getParameter("submitted").equals("true")) {
      ...
      if (actionId.equals("3")) { //Remove
        query = "UPDATE featured_products SET " + request.getParameter("columnName") + "=" + newValue + ", last_action_id=" + actionId + " WHERE product_id=" + request.getParameter("primaryKeyValue");
      } else if (actionId.equals("4")) {  //Reorder
        query = "UPDATE featured_products SET " + request.getParameter("columnName") + "=" + newValue + ", last_action_id=" + actionId + ", last_sequence=" + lastSequence + " WHERE product_id=" + request.getParameter("primaryKeyValue");
      }
