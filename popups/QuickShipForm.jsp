...
<body onLoad="document.forms[0].jobId.focus();"> 
	<form method-"post" name="myForm" action="/minders/workflowforms/InterimShipment2fromQuick.jsp">
		<p class='title'>Enter Shipment</p><p class='body'>Enter shipment for the following job:</p>
		Job ID:<input type='text' name='jobId'><input type=submit value=' CONTINUE '>
	<input type="hidden" name="actionId" value="77">
	</form>
</body>
</html>