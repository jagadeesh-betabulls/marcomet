...
<body onload="document.forms[0].txtCheckNumber.focus();" >
<form method="POST" name="addEntry" action="SubmitForm.jsp" onSubmit="return checkAddFormData(); return setCompInfo();">
<input type="hidden" name="act" value="">
<%
    String __act = request.getParameter("act");
   if(__act.equals("exit")) {
    response.sendRedirect("/app-admin/AdminMenu.jsp");
    return;
   }
	...
	if(compId.equals("-1")) {
		...
		response.sendRedirect("EntryForm.jsp?mode=repeat&message=No records found.");
		return;
	}
%>
          ...
          <tr> 
            ...
            <td  valign="top" > <table width="100%" cellpadding="0" cellspacing="1">
                ...
                <tr> 
                  ...
                  <td  class="text-row2"><input type="text" name="txtCheckNumber" size="20" maxlength='32' class="textBox"></td>
              ...
              <table width="100%" cellpadding="0" cellspacing="1">
                ...
                <tr> 
                  <td colspan="5" align="left" class="table-subheading">
                    ...
                    <%
                      ...
                      if(gotoNext == null){
                        invoiceList= CustomerPaymentDAO.getInvoices(Integer.parseInt(compId.trim()));
			    ...
			    String suffStr = invFormate.toString().substring(invFormate.toString().indexOf(".")+1);
			    if(suffStr.length() == 0) {
