...
function NewCal(pCtrl,pFormat,pShowTime,pTimeMode,pScroller)
{
	...
	if (Agent.indexOf("FIREBIRD")==-1)//for Mozilla Firebird
		...
		winHeight=245;
	winCal=window.open("","DateTimePicker","toolbar=0,status=0,menubar=0,fullscreen=no,width=200,height="+winHeight+",resizable=0,top="+cnTop+",left="+cnLeft);
...
function RenderCal()
{
	...
	docCal.open();
	docCal.writeln("<html><head><style>a {font-size: 10pt;} td {font-size: 10pt;}</style><title>"+WindowTitle+"</title>");
	...
	if (Cal.Scroller=="DROPDOWN")
	{
		...
		//Year selector
		vCalHeader+="\n<td align='right'><a href=\"javascript:winMain.Cal.DecYear();winMain.RenderCal()\"><b><font color=\""+YrSelColor+"\"><</font></b></a><font face=\"Verdana\" color=\""+YrSelColor+"\" size=2 style='font-size:12pt'><b> "+Cal.Year+" </b></font><a href=\"javascript:winMain.Cal.IncYear();winMain.RenderCal()\"><b><font color=\""+YrSelColor+"\">></font></b></a></td></tr></table></td>\n";	
		vCalHeader+="</tr>";
	}
	...
	if ((ShowMonthYear)&&(Cal.Scroller=="DROPDOWN"))
		vCalHeader+="<tr><td colspan='7'><font face='Verdana' size='2' align='center' color='"+MonthYearColor+"'style='font-size:12pt;'><b>"+Cal.GetMonthName(ShowLongMonth)+" "+Cal.Year+"</b></font></td></tr>\n";
	//Week day header
	vCalHeader+="<tr bgcolor="+WeekHeadColor+">";
	for (i=0;i<7;i++)
	{
		vCalHeader+="<td align='center'><font face='Verdana' size='2'style='font-size:12pt;'>"+WeekDayName[i].substr(0,WeekChar)+"</font></td>";
	}
	vCalHeader+="</tr>";	
