...
<form method="post" action="<%=((request.getParameter("reportType")==null)?"/app-admin/payments/reports/AccruedBalanceReport.jsp":request.getParameter("reportType"))%>" >
  ...
  <table dwcopytype="CopyTableRow"><tr> 
      ...
      <OPTION value="/app-admin/payments/reports/ShipAccrualXtionReport.jsp" onChange='document.forms[0].action=this.value' <%=((request.getParameter("reportType")!=null && request.getParameter("reportType").equals("/app-admin/payments/reports/ShipAccrualXtionReport.jsp"))?"SELECTED":"")%> >Ship Accrual Transaction Report</OPTION>
