...
<form name="viewListForm" method="POST" action="ViewListForm.jsp" onSubmit="return setCompInfo()">
...
Integer compId = new Integer(t_compName.substring(t_compName.indexOf("##") +2,t_compName.length()));
              ...
              <tr> 
                ...
                <td  colspan="3" class="text-row2" > 
                  ...
                  <input type="text" name="InvoiceNo" value="" size="24" maxlength="5" class="TextBox" >
              ...
              <tr> 
                ...
                <td class="text-row1" >Check Date From </td>
              ...
              <tr> 
                ...
                <td class="text-row1">Check Date To </td>
                  ...
                  <!--<table width="100%" border="0" cellpadding="0" cellspacing="1" >
                    ...
                    <tr>
                      ...
                      <td width="3%" class="textlb" align="left">
                        ...
                        <a  class="textlb" href="ViewListForm.jsp?NEXT=First&CURRENT_PAGE=<%=firstPage%>&call=view&cId=<%=cId%>" onClick='return setCompInfo()' >First </a>

                      </td>

					  <td width="3%" class="textlb" align="left">

                        <a  class="textlb" href="ViewListForm.jsp?NEXT=Prev&CURRENT_PAGE=<%=prevPage%>&call=view&cId=<%=cId%>" onClick='return setCompInfo()' >Prev </a>
		       	...
		       	lastPage = 1;
                      ...
                      <td width="3%" class="textlb" align="right">
                        ...
                        <a class="textlb" href="ViewListForm.jsp?NEXT=Next&CURRENT_PAGE=<%=nextPage%>&call=view&cId=<%=cId%>" onClick='return setCompInfo()'>Next </a> 

                      </td>

                      <td width="3%" class="textlb" align="right">

                        <a  class="textlb" href="ViewListForm.jsp?NEXT=Last&CURRENT_PAGE=<%=lastPage%>&call=view&cId=<%=cId%>" onClick='return setCompInfo()'>Last </a>
                ...
                <td colspan='4'>
                  ...
                  <tr>
                    ...
                    <td align="left" class="text-row2" >
                      ...
                      <a href="EditForm.jsp?cId=<%=compId%>&cName=<%=compName%>&checkNo=<%=checkNo%>&checkDate=<%=checkDate%>&checkAmt=<%=checkAmt%>&depositDate=<%=depositDate%>"><%=checkNo%></a>
