...
<table border="0" width="100%">
  ...
  <tr>
    <td><u><span class="label">Proposed:</span></u> <span class="body"><%= changesRS.getString("created_date") %></span> <span class="label">as</span> <span class="body"><$ change_type$></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="label"><$ status $></span> <%= (changesRS.getString("status").equals("Pending")) ? "":": <span class=\"body\">" + changesRS.getString("customer_date") + "</span>"%></td>
  </tr>
  <tr>
