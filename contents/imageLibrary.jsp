...
<table cellpadd1ng=3 cellspacing=0 border=0 align=center width='300'>
	...
	System.out.println("request.getParameter('dom') is "+request.getParameter("dom"));
%>
<form method="post" action='<%=((request.getParameter("dom")==null)?"http://wam.marcomet.com":request.getParameter("dom"))%>/DigitalAssets/login.php' >
<input type="hidden" name="url" value="index.php">
<input type="hidden"  name="remember" id="remember" value="yes" >
...
System.out.println("wam_un is "+session.getAttribute("wam_un"));
System.out.println("wam_pw is "+session.getAttribute("wam_pw"));
} else {
