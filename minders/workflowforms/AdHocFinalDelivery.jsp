...
<p class="Title">Deliver Final Work</p><p> <b>Instructions:</b> <span class="body">Use this form to deliver a file upload or record a shipment of materials that are considered the   final work product for this job.   You may make as many deliveries of final materials as necessary on the job.  Uploaded files will be archived and labeled "final" for easy identification and retrieval.</span></p>
