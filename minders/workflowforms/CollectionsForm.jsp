...
<%	session.setAttribute("errorMessage","");%>
    ...
    <%}else{%>
    <a href="javascript:parent.window.location.replace('http://<%= ( ( com.marcomet.environment.SiteHostSettings)request.getSession().getAttribute("siteHostSettings")).getDomainName()%>/');" class="greybutton">Thank You! Continue</a>
