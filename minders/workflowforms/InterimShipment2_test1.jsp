...
%><p class="Title"><%=((shipAdjust) ? "Shipping Adjustment" : "Interim Shipping")%></p>
    ...
    if (!(shipAdjust)) {%> <table border="1" cellpadding="5" cellspacing="0" >
        ...
        <tr>
          ...
          <span id='show_d_s' style="display:none;"></span><input type="text" class="lineitemsright" id="f_trigger_c"  readonly="true" onFocus="this.style.background='yellow';"
                                                                                                                                                                           onBlur="this.style.background=''">Choose Ship Date</span>
            <script type="text/javascript">
              Calendar.setup({
                inputField     :    "f_adjdate_d",
                ifFormat       :    "%Y-%m-%d",
                displayArea    :    "show_d_s",
                daFormat       :    "%A, %m-%d-%Y",
                button         :    "f_trigger_c",
                align          :    "BR",
                singleClick    :    true,
              ...
              document.getElementById('f_trigger_c').value=aweekday[d.getDay()]+", "+ (d.getMonth()+1)+"-"+d.getDate()+"-"+d.getFullYear();
              function showdDate(){
              	document.getElementById('f_trigger_c').value=show_d_s.innerHTML
