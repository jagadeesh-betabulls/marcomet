...
<%@ page import="java.sql.*, com.marcomet.jdbc.*, com.marcomet.environment.*;" %>
...
//Cycle through all products and update the inventory and on-order amounts
		...
		String productSQL="SELECT * from products where status_id<>3 and status_id<>4 "+((productId.equals("0"))?"":" AND id="+productId);
