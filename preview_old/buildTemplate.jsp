...
for (i = 1; i <= pagecount; i++) {
	...
	f=0;
	x=0;
    for (int z=0; z<vBlocks.size(); z=z+10) {
...
if (saveFile){
	...
	if(overFlow){
		...
		%></ul></div><%
	}%><table width=100% height=100% cellpadding="0" cellspacing="0" border="0"><tr><td align="center" valign="top"><span class='subtitle'><i> Click image for full-size preview<!--<br>NOTE: Colors in preview image are approximate; final printed product colors may vary.</i></span>--><br><%=((pageButtons.equals(""))?"":pageButtons+"<br>")%><a href="<%=tempUrlPath+pdfFileName.replace(".pdf","_proof.pdf")%>" target='_blank' ><img src="<%=tempUrlPath +imageFileName%>" border=1 ></a></td></tr></table>
	<script>
