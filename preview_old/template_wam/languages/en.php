...
# Team Center
$lang["manageresources"]="Manage Files";
$lang["managemyresources"]="Manage My Files";
$lang["overquota"]="Over disk space quota; cannot add files";
$lang["managearchiveresources"]="Manage Archive files";
$lang["managethemes"]="Manage Resource Groups";
...
$lang["copyresource"]="Copy File";
$lang["resourceidnotfound"]="The file ID was not found";
$lang["inclusive"]="(inclusive)";


# Team Center - Bulk E-mails
...
# Team Center - User management
$lang["comments"]="Comments";

# Team Center - Resource management
$lang["viewuserpending"]="View User Contributed Files Pending Review";
$lang["searcharchivedresources"]="Search Archived Files";
$lang["viewresourcespendingarchive"]="View Files Pending Archive";
$lang["uploadresourcebatch"]="Upload File Batch";
...
$lang["resourcesuploadedok"]="files uploaded OK"; # E.g. 17 resources uploaded OK
$lang["failed"]="failed";
$lang["clickviewnewmaterial"]="Click 'View New Material' to see uploaded files.";
...
# User contributions
$lang["contributenewresource"]="Contribute New File";
$lang["viewcontributedps"]="View My Contributions - Pending Submission";
$lang["viewcontributedpr"]="View My Contributions - Pending File Team Review";
...
$lang["allowothersaddremove"]="Allow other users to add/remove files";
$lang["resetarchivestatus"]="Reset archive status for all files in collection";
$lang["editallresources"]="Edit all files in collection";
$lang["editresources"]="Edit files";
$lang["multieditnotallowed"]="Mult-edit not allowed - all the files are not in the same status or of the same type.";
...
$lang["findpubliccollection"]="Find a Public Collection";
...
$lang["emailcollectionmessage"]="has e-mailed you a collection of files from $applicationname which has been added to your 'My Collections' page."; # suffixed to user name e.g. "Fred has e-mailed you a collection.."
$lang["clicklinkviewcollection"]="Click the link below to view the collection.";
 
# Resource create / edit / view
$lang["createnewresource"]="Create New File";
$lang["resourcetype"]="File Type";
$lang["resourcetypes"]="File Types";
$lang["deleteresource"]="Delete File";
$lang["downloadresource"]="Download File";
$lang["rightclicktodownload"]="Right click this link and choose 'Save As' to download your file...";
$lang["downloadinprogress"]="Download In Progress";
$lang["editmultipleresources"]="Edit Multiple Files";
$lang["editresource"]="Edit File";
$lang["resourcesselected"]="files selected"; # e.g. 17 resources selected.
$lang["image"]="Image";
...
$lang["specifydefaultcontent"]="Specify Default Content For New Files";
$lang["properties"]="Properties";
$lang["relatedresources"]="Related Files";
$lang["indexedsearchable"]="Indexed, searchable fields";
$lang["clearform"]="Clear Form";
$lang["similarresources"]="similar files"; # e.g. 17 similar resources
$lang["similarresource"]="similar file"; # e.g. 1 similar resource
$lang["nosimilarresources"]="No similar files";
$lang["emailresource"]="E-mail Link";
$lang["resourcetitle"]="File Title";
$lang["requestresource"]="Request File";
$lang["viewmatchingresources"]="View matching files";
$lang["nomatchingresources"]="No matching files";
$lang["matchingresources"]="matching files"; # e.g. 17 matching resources
...
$lang["youfoundresources"]="files"; # e.g. you found 17 resources
...
$lang["delete"]="Delete";
$lang["log"]="Log";
$lang["resourcedetails"]="File Details";
$lang["offlineresource"]="Offline File";
$lang["request"]="Request";
$lang["searchforsimilarresources"]="Search for similar files";
$lang["clicktoviewasresultset"]="Click to view these files as a result set";
$lang["searchnomatches"]="Your search did not match any files.";
$lang["try"]="Try";
...
$lang["hasemailedyouaresource"]="has e-mailed you a file"; # Suffixed to user name, e.g. Fred has e-mailed you a resource
$lang["clicktoviewresource"]="Click the link below to view the file.";

# Resource log - actions
$lang["resourcelog"]="File Log";
$lang["log-u"]="Uploaded file";
$lang["log-c"]="Created file";
$lang["log-d"]="Downloaded file";
$lang["log-e"]="Edited file field";
$lang["log-m"]="Edited file field (multi-edit)";
$lang["backtoresourceview"]="Back to file view";
...
$lang["accountexpired"]="Your account has expired. Please contact the files team.";
...
$lang["noresourcesrequired"]="Number of files required for final product?";
...
$lang["copyexistingresources"]="Copy the files in an existing collection to this research brief";
...
$lang["researchrequestassignedmessage"]="Your research request has been assigned to a member of the team. Once we've completed the research you'll receive an e-mail with a link to all the files that we recommend.";
...
$lang["backtoteamhome"]="back to Admin Center home";
$lang["resourceid"]="File ID";
$lang["id"]="ID";
$lang["date"]="Date";
$lang["todate"]="To Date";
...
$lang["backtoview"]="File View";
$lang["backtoeditresource"]="Back to edit file";
...
$lang["stat-addresourcetocollection"]="Add files to collection";
...
$lang["stat-createresource"]="Create file";
$lang["stat-e-mailedcollection"]="E-mailed collection";
$lang["stat-e-mailedresource"]="E-mailed file";
$lang["stat-keywordaddedtoresource"]="Keyword added to file";
...
$lang["stat-resourcedownload"]="File download";
$lang["stat-resourceedit"]="File edit";
$lang["stat-resourceupload"]="File upload";
$lang["stat-resourceview"]="File view";
...
$lang["removeallresourcesfromcollection"]="Remove all files from this collection";
$lang["deleteallresourcesfromcollection"]="Delete all files in this collection";
$lang["deleteallsure"]="Are you sure you wish to DELETE these files? This will delete the files themselves, not just remove them from this collection.";
$lang["batchdonotaddcollection"]="(do not add to a collection)";
$lang["collectionsthemes"]="Related resource groups and public collections";
$lang["recent"]="Recent";
$lang["batchcopyfrom"]="Copy data from file with ID";
$lang["copy"]="Copy";
$lang["zipall"]="Zip all";
...
$lang["confirmeditall"]="Are you sure you wish to save? This will overwrite the existing values(s) for the selected field(s) for all the files in your current collection.";
$lang["collectiondeleteconfirm"]="Are you sure you wish to delete this collection?";
$lang["hidden"]="(hidden)";
$lang["requestnewpassword"]="Request New Password";

# New for 1.4
$lang["reorderresources"]="Reorder files within collection (hold and drag)";
$lang["addorviewcomments"]="Add or view comments";
$lang["collectioncomments"]="Collection Comments";
$lang["collectioncommentsinfo"]="Add a comment to this collection for this file. This will only apply to this collection.";
$lang["comment"]="Comment";
$lang["warningexpired"]="File Expired";
$lang["warningexpiredtext"]="Warning! This file has exceeded the expiry date. You must click the link below to enable the download functionality.";
$lang["warningexpiredok"]="&gt; Enable file download";
$lang["userrequestcomment"]="Comment";
$lang["addresourcebatchbrowser"]="Add File Batch - In Browser (recommended)";
$lang["addresourcebatchftp"]="Add File Batch - FTP";
$lang["replaceresourcebatch"]="Replace File Batch";
...
$lang["relateallresources"]="Relate all files in this collection";
...
$lang["viewduplicates"]="View Duplicate Files";
...
# Added
$lang["detail"]="Detail";
$lang["thumblist"]="Thumbnail List";
$lang["file_extension"]="File Extension";
$lang["executebatchjobonsearchitems"]="Perform Action(s) on Search Results";
$lang["fileuploadstep2text"] = "Click on the \"Select images to be uploaded\" button to choose the multiple images you would like to upload. The upload will start once the images are chosen.";
...
$lang["thumblist"]="Thumbnail List";
$lang["bybrand"]="Brand";
$lang["anybrand"]="Any Brand";
$lang["byinitiative"]="Initiative";
$lang["anyinitiative"]="Any Initiative";
$lang["fileusageinformation"] = "File Usage Information";
$lang["fileusageinformationcontents"] = "For use with _________";
$lang["sitebrand"]="Site ID/Brand";
$lang["resourcenotfound"] = "Error: Resource Not Found";
$lang["sitebrand"]="Site ID/Brand";
$lang["displayvariants"]="Display Resource Variants";
?>