...
$mysql_db="marcomet_dams";			# MySQL database name
...
$baseurl="http://dam.marcomet.com/DigitalAssets"; # The 'base' web address for this installation. Note: no trailing slash
...
include "version.php";
$applicationname="Marcomet Digital Resource Server"; # The name of your implementation / installation (e.g. 'MyCompany Resource System')
...
$ftp_server="dam.virtual.vps-host.net";
