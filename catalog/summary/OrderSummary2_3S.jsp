...
<form method="post" action="/servlet/com.marcomet.sbpprocesses.ProcessJobSubmit" >
        ...
        for (int j = 0; j < shipments.size(); j++) {
          ...
          <tr>
            <td class="lineitems">
              ...
              <div align="center"><a href="/catalog/summary/RemoveProjectConfirmation.jsp?projectId=<%= projectId + ""%>&confirm=true" class="minderACTION">delete</a></div>
            </td>
  ...
  if (creditStatus != 2 && overLimit) {
          ...
          <tr>
            <td>
              <jsp:include page="/catalog/checkout/OrderCheckOutForm.jsp" flush="false"></jsp:include>
            </td>
          </tr>
        </table>
      </td>
