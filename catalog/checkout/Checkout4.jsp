    	...
    	if (!promoCode.equals("")){
    	    ResultSet rsPromoSH = st.executeQuery("Select * from promo_sitehost_bridge where promo_code='"+promoCode+"' and exclude_sitehost=0");
	 		...
	 		if (excludeSitehostFromPromo){
		 		...
		 		ResultSet rsPromoSH3 = st.executeQuery("Select * from promo_customer_bridge where promo_code='"+promoCode+"' and site_number='"+up.getProperties()+"'");
	 			if(rsPromoSH3.next()){
...
%><div class="title" id="title">Order Review / Checkout - site: <%= up.getProperties() %></div><%
