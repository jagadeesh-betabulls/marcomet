...
<html>
  ...
  <body bgcolor="#FFFFFF" text="#000000"  onLoad="populateTitle('Order Checkout')" background="<%=(String) session.getAttribute("siteHostRoot")%>/images/back3.jpg">
    ...
    <div id="formSection" style="display:block;"><p class="Title">Process Jobs Confirmation</p>
      <form method="post" action="/servlet/com.marcomet.sbpprocesses.ProcessJobSubmit" >
        ...
        <table align="center" width="80%" class=label>
          ...
          <tr>
            <td colspan="4" class="subtitle1">Shipping Address:</td>
          </tr>
          <tr>
    ...
    if (shipmentOption.equals("1")) {
          ...
          <tr align="center">
            <td colspan="3">
              <input name="shipmentOption" value="0" type="radio" onclick="if(this.checked){parent.window.location.replace('/catalog/summary/OrderSummary2.jsp?shipmentOption=2');}" checked>&nbsp;Hold and Ship items together where possible to minimize shipping cost
              &nbsp;
              <input name="shipmentOption" value="1" type="radio" onclick="if(this.checked){parent.window.location.replace('/catalog/summary/OrderSummary2.jsp?shipmentOption=2');}">&nbsp;Ship items as they become available
            </td>
          </tr>
