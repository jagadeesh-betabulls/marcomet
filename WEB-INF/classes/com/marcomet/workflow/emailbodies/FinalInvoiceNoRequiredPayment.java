...
History:
	...
	8/12/03		steve davis		use 'relative' domain by order origination
...
public class FinalInvoiceNoRequiredPayment extends EmailBodyBaseClass implements EmailBodyInterface {
	...
	public String getBody(MultipartRequest mr) throws SQLException{
		...
		String key = "FinalInvoiceNoRequiredPayment";	
		...
		//set domain to the order origination domain
