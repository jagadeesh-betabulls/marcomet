...
History:
	...
	8/1/01		td				updated to handle the new email baseclass
...
public class JobCompProofApproved extends EmailBodyBaseClass implements EmailBodyInterface {
	...
	public String getBody(MultipartRequest mr) throws SQLException{
		String key = "JobCompProofApproved";
