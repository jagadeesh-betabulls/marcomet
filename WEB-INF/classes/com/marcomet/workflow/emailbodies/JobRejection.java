...
Description:	This class will generate an html body email for a job
				rejection before a confirmation.
...
History:
	...
	8/2/01		td				updated to use the new EmailBaseClass
...
public class JobRejection extends EmailBodyBaseClass implements EmailBodyInterface {
	...
	public String getBody(HttpServletRequest request) throws SQLException{	
		...
		//set domain by order origintaion
