...
Description:	This class will generate an html body email for a job
				final invoice submited requireing payment immedatly.
...
History:
	...
	8/2/01		td				updated to extend new EmailBase Class
...
public class FinalInvoiceRequiredPayment extends EmailBodyBaseClass implements EmailBodyInterface {
	...
	public String getBody(MultipartRequest mr) throws SQLException{
		...
		String key = "FinalInvoiceRequiredPayment";
		...
		//set domain to order origination domain
