...
Description:	This class will generate an html body email for a RFQ job
				response from the buyer for requote.

History:
	Date		Author			Description
	----		------			-----------
	8/16/2001	Thomas Dietrich	Created
	8/12/03		steve davis		use 'relative' domain to vendor id
...
public class RFQResubmittedForRequote extends EmailBodyBaseClass implements EmailBodyInterface {
	...
	protected String key = "RFQBuyerResubmission";
