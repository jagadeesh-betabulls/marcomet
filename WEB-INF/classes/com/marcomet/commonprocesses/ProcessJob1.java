...
public class ProcessJob1 {
  ...
  public final int processInsert() throws SQLException {
    ...
    String insertSQL = "INSERT INTO jobs(id,cancelation_date,project_id,job_type_id,job_notes,internal_reference_data,promo_code,job_name,last_status_id,status_id,service_type_id,cost,mu,site_host_global_markup,fee,marcomet_global_fee,ship_cost_policy,ship_price_policy,std_ship_price,price,escrow_amount,escrow_percentage,ordered_by_id,vendor_id,vendor_company_id,vendor_contact_id,sales_contact_id,sales_company_id,shipment_id,percentage_of_shipment,reprinted_from_jobid,ship_location_id,discount,jorder_id,subvendor_reference_data) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    Statement qs = null;
    ...
    try {
      ...
      insert.setInt(17, 0);
      insert.setInt(18, getShipPricePolicy());
      insert.setDouble(19, getStdShipPrice());
      insert.setDouble(20, getPrice());
      insert.setDouble(21, getEscrowAmount());
      insert.setDouble(22, getEscrowPercentage());
      insert.setInt(23, getOrderedById());
      insert.setInt(24, getVendorId());
      insert.setInt(25, getVendorCompanyId());
      insert.setInt(26, getVendorContactId());
      insert.setInt(27, getSalesContactId());
      insert.setInt(28, getSalesCompanyId());
      insert.setInt(29, getShipmentId());
      insert.setDouble(30, getPercentageOfShipment());
      insert.setString(31, getPriorJobId());
      insert.setInt(32, getShipLocationId());
      insert.setDouble(33, getDiscount());
      insert.setDouble(34, getOrderId());
      insert.setString(35, getSubvendorReferenceData());
