...
<form name="entryForm" method="POST" action="AddEntryFromQuick.jsp" onSubmit="return setCompInfo()">
<input type="hidden" name="cId" value="">
<input type="hidden" name="cName" value="">
<input type="hidden" name="act" value="">
<%
    String siteHostId = (String)request.getSession().getAttribute("siteHostId"); 
// commented out by CSA to bypass secondary login for quick entry
//      if(siteHostId==null)
//      {
      ...
      <td valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td bgcolor="f3f1f1"> <table width="100%" border="0" cellpadding="0" cellspacing="1">
                <tr> 
                  <td colspan="2" class="table-heading">ENTER COMPANY/INVOICE/JOB INFORMATION/ORDER NUMBER</td>
                </tr>
                <tr> 
		...
		while(iter.hasMoreElements())
		{
         ...
         <tr> 
                  <td class="text-row1" >Order Number</td>
                  <td class="text-row2" >
                  <input type="text" name="orderNumber" size="24" class="textbox" maxlength="8">
                </tr>
		  <tr> 
