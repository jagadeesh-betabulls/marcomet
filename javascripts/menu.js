...
MenuContainer.prototype = {
	...
	open: function() {
	  ...
	  if (this.menuType == "dropdown") {
		...
		if((this.parent.element.offsetTop - parentMenuBorders["top"] - this.menuItems[0].element.offsetTop)> 220){
			Element.setStyle(this.element,{
	    		top: (this.parent.element.offsetTop - parentMenuBorders["top"] - this.menuItems[0].element.offsetTop-180) + "px"
	    		});
		}else{
			Element.setStyle(this.element,{
