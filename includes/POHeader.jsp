...
<table border="0" cellpadding="5" cellspacing="0" width="100%">
  <tr>
    <td class="tableheader">Purchased by Vendor:</td>
    <td class="tableheader">On behalf of its Client:</td>
	<td class="tableheader">From Supplier/Subvendor:</td>
	<td class="tableheader">Ship from Warehouse</td>
    <td class="tableheader">Order Date:</td>
    <td class="tableheader">Vendor/Purchasor Job #:</td>
    <td class="tableheader">Vendor/Purchasor PO #:</td>
  </tr>
  <tr>
    ...
    <td class="lineitems"><%if (editor){%><a href='javascript:popw("/popups/QuickChangeForm.jsp?cols=5&rows=1&question=Change%20Warehouse%20ID&primaryKeyValue=<%=request.getParameter("jobId")%>&columnName=jwarehouse_id&tableName=jobs&valueType=integer",200,100)'>&raquo;</a>&nbsp;<%}%><%=((headerRS.getString("warehouse_id")==null)?"NONE":headerRS.getString("warehouse_name") +"["+headerRS.getString("warehouse_id")+"]")%></td>
 ...
 <tr>
  ...
  <tr>
	...
	String postStr=((qtyRS.getString("full_picurl")==null || qtyRS.getString("full_picurl").equals(""))?"":"</a>");
				prod_thumb=((qtyRS.getString("prod_thumb")==null || qtyRS.getString("prod_thumb").equals(""))?"":"<tr><td colspan=7>"+preStr+"<img src='"+prod_thumb_pre+qtyRS.getString("prod_thumb")+"' border=1>"+postStr+"</td></tr>");
	...
	%><tr><td class="tableheader" width=20% >Terms</td><td class="tableheader" width=80%>Order &amp; Fulfillment Process</td></tr>
	 ...
	 if (headerRS.getString("logo_image")!=null){%>
	  ...
	  <tr><td class="lineitems" align="center" ><%=headerRS.getString("brand")%></td><td class="lineitems" align="center" ><img src='/sitehosts/<%=headerRS.getString("sitehost_name")+"/images/"+headerRS.getString("logo_image")%>' ></td></tr>
<%}%></table><%=prod_thumb%>
</iterate:dbiterate>
