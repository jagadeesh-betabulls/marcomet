...
%>
  ...
  %><script>
        ...
        <input name="titleId" type="hidden" size="20" max="20" value="<%= cB.getTitleIdString() %>" >
        <input name="firstName" type="hidden" size="20" max="20" value="<%= cB.getFirstName() %>" >
        <input name="lastName" type="hidden" size="30" max="30" value="<%= cB.getLastName() %>" >
		<input name="companyName" type="hidden" size="32" max="64" value="<%= cB.getCompanyName() %>"
		<input type="hidden" name="jobTitle" size="20" max="20" value="<%= cB.getJobTitle() %>" >
		<input type="hidden" name="email" value="<%= cB.getEmail() %>" >
		<input type="hidden" name="companyURL" value="<%= cB.getCompanyURL() %>" ><%
    ...
    <tr> 
      ...
      <td> 
        ...
        <select name="ccYear">
          ...
          <option value="10" <%=(ccYear.equals("10"))?"Selected":""%>>2011</option>
		  ...
		  <option value="11" <%=(ccYear.equals("11"))?"Selected":""%>>2021</option>
        </select>
      </td>
    </tr>
       <tr> 
