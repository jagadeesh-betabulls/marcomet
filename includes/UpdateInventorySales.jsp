...
String productSQL="SELECT *,(inv_on_order_amount-inventory_amount) as amount_available,first_sales_date,YEAR(first_sales_date) as firstSalesYear,MONTH(first_sales_date)-1 as firstSalesMONTH, dayofmonth(first_sales_date) as firstSalesDay from products where status_id=2 "+((productId.equals("0"))?"":" AND id="+productId)+" AND first_sales_date='0000-00-00' order by root_inv_prod_id";
...
while(rsProds.next()){
		...
		if (rsProds.getString("first_sales_date")==null || rsProds.getString("first_sales_date").equals("") || rsProds.getString("first_sales_date").equals("0000-00-00")){
