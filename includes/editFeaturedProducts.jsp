...
<div align="left" width="98%">
  ...
  <a href='javascript:pop("/popups/ViewHistoryFeaturedProduct.jsp",1000,400)' class="greybutton"> View History </a>
...
while(rsProds.next()){
	...
	if (x==1){
	%><tr><td width="48%" class='borderAboveLeft<%=((y==0)?"Intro":"")%>'><%
	      if (request.getParameter("edit") != null && request.getParameter("edit").equals("true")) {
        if (y == 0) {
      %>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="right" width="98%">
            <a href='javascript:pop("/popups/QuickChangeReorderFeaturedProduct.jsp?page=true&primaryKeyValue=<%=rsProds.getString("id")%>&columnName=sequence&actionId=4&title=Set%20Order&lastSequence=<%=rsProds.getString("sequence")%>",700,150)' class=greybutton> SET ORDER [<%=rsProds.getString("sequence")%>] </a>
            <br>
          </td>
        </tr>
      </table>
 ...
 %><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td width="98%" valign="top"><%if (editor && rsProds.getString("type").equals("text")){%><a href='javascript:pop("/popups/QuickChangeForm.jsp?cols=60&rows=6&question=Change%20Title&primaryKeyValue=<%=rsProds.getString("id")%>&columnName=title&tableName=pages&valueType=string",500,200)'>&raquo;</a>&nbsp;<%}%><%=prodName%><%=smallPicURL%><%=brandStandard%><%=features%><%if (editor && rsProds.getString("type").equals("text")){%><a href='javascript:pop("/popups/QuickChangeForm.jsp?cols=60&rows=6&question=Change%20Text&primaryKeyValue=<%=rsProds.getString("id")%>&columnName=body&tableName=pages&valueType=string",500,200)'>&raquo;</a>&nbsp;<%}%><%=summary%><%=((rsProds.getString("sale_title") !=null && !rsProds.getString("sale_title").equals(""))?"<div class='saleLINK'><span class='saleLINKTitle'>"+rsProds.getString("sale_title")+"</span><br>"+rsProds.getString("sale_desc")+order+"<br /></div>":order)%></td></tr></table></td><%
		y++;
	}else if(x==2){
	%><td width="4%" >&nbsp;</td>
    <td width="48%"  class='borderAboveRight'>      <%if (request.getParameter("edit") != null && request.getParameter("edit").equals("true")) {
        if (y == 0) {
      %>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
      ...
      %>
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%"><tr><td width="98%" valign="top"><%if (editor && rsProds.getString("type").equals("text")){%><a href='javascript:pop("/popups/QuickChangeForm.jsp?cols=60&rows=6&question=Change%20Title&primaryKeyValue=<%=rsProds.getString("id")%>&columnName=title&tableName=pages&valueType=string",500,200)'>&raquo;</a>&nbsp;<%}%><%=prodName%><%=smallPicURL%><%=brandStandard%><%=features%><%if (editor && rsProds.getString("type").equals("text")){%><a href='javascript:pop("/popups/QuickChangeForm.jsp?cols=60&rows=6&question=Change%20Text&primaryKeyValue=<%=rsProds.getString("id")%>&columnName=body&tableName=pages&valueType=string",500,200)'>&raquo;</a>&nbsp;<%}%><%=summary%><%=((rsProds.getString("sale_title") !=null && !rsProds.getString("sale_title").equals(""))?"<div class='saleLINK'><span class='saleLINKTitle'>"+rsProds.getString("sale_title")+"</span><br>"+rsProds.getString("sale_desc")+order+"<br /></div>":order)%></td>
		        <td width="1%" rowspan="2" valign="top"><img name="" src="" width="8px" height="1" alt="" /></td>
		        <td rowspan="2" width="1%"  valign="top"></td></tr></table></td></tr><%
		} else if (x==3){
		%><tr><td width="48%"  class='borderAboveRight'>      <%if (request.getParameter("edit") != null && request.getParameter("edit").equals("true")) {
        if (y == 0) {
      %>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
      ...
      %>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	      <tr><td rowspan="2" width="1%"  valign="top" ></td><td width="1%" rowspan="2" valign="top"><img name="" src="" width="8px" height="1" alt="" /></td>
		        <td width="98%" valign="top"><%if (editor && rsProds.getString("type").equals("text")){%><a href='javascript:pop("/popups/QuickChangeForm.jsp?cols=60&rows=6&question=Change%20Title&primaryKeyValue=<%=rsProds.getString("id")%>&columnName=title&tableName=pages&valueType=string",500,200)'>&raquo;</a>&nbsp;<%}%><%=prodName%><%=smallPicURL%><%=brandStandard%><%=features%><%if (editor && rsProds.getString("type").equals("text")){%><a href='javascript:pop("/popups/QuickChangeForm.jsp?cols=60&rows=6&question=Change%20Text&primaryKeyValue=<%=rsProds.getString("id")%>&columnName=body&tableName=pages&valueType=string",500,200)'>&raquo;</a>&nbsp;<%}%><%=summary%><%=((rsProds.getString("sale_title") !=null && !rsProds.getString("sale_title").equals(""))?"<div class='saleLINK'><span class='saleLINKTitle'>"+rsProds.getString("sale_title")+"</span><br>"+rsProds.getString("sale_desc")+order+"<br /></div>":order)%></td>
		  </tr> </table></td><%
		}else if (x==4){
			%><td width="4%" >&nbsp;</td>
		    <td width="48%" class='borderAboveLeft'>      <%if (request.getParameter("edit") != null && request.getParameter("edit").equals("true")) {
        if (y == 0) {
      %>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
...
if (x==1 || x==3){
	%><td width="4%" >&nbsp;</td>
    <td width="48%" class='borderAboveLeft'><table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
      <tr>
...
rsProds.close();st.close();conn.close();
%></table>